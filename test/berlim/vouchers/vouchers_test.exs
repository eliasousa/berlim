defmodule Berlim.VouchersTest do
  ...
  describe "vouchers" do
    ...
    @valid_attrs %{from: "some from", km: "some km", note: "some note", payed_at: ~N[2010-04-17 14:00:00], to: "some to", value: 120.5}
    @update_attrs %{from: "some updated from", km: "some updated km", note: "some updated note", payed_at: ~N[2011-05-18 15:01:01], to: "some updated to", value: 456.7}
